...
var {StyleSheet, View, Text, NativeModules,Dimensions,Platform} = ReactNative;
...
class SectionList extends Component {
  ...
  detectAndScrollToSection(e) {
    ...
    //    if (this.lastSelectedIndex !==e index) {
    ...
    let { y, height } = this.measure;
    let scale=screenHeight/667;
    y = 253 * scale;
    ...
    if(!y || targetY < y){
      ...
      let scrollY = Platform.OS !== 'ios'? targetY - y + height: targetY - y;
      index = Math.floor(scrollY / height);
